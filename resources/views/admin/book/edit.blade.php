        ...
        <div class="bg-white rounded-xl shadow-lg p-8">
            <form action="{{ route('admin.books.update', $book->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea
                            ...
                            id="excerpt" name="excerpt" placeholder="Masukkan ringkasan singkat buku"
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea
                            ...
                            id="description" name="description" placeholder="Masukkan deskripsi lengkap buku"
                    ...
                    <div>
                        ...
                        <select
                            ...
                            <option value="nurse" {{ old('audience_type', $book->audience_type) == 'nurse' ? 'selected' : '' }}>Perawat</option>
                            <option value="midwife" {{ old('audience_type', $book->audience_type) == 'midwife' ? 'selected' : '' }}>Bidan</option>
                        </select>
                        @error('audience_type')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="url"
                            ...
                            id="buy_link" name="buy_link" value="{{ old('buy_link', $book->buy_link) }}"
                    ...
                    <div class="md:col-span-2">
                        ...
                        <select
                            ...
                            <option value="published" {{ old('status', $book->status) == 'published' ? 'selected' : '' }}>
                                Published</option>
                            <option value="draft" {{ old('status', $book->status) == 'draft' ? 'selected' : '' }}>Draft
                            </option>
                        </select>
                        @error('status')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                ...
                <div class="flex items-center justify-end space-x-4 mt-8 pt-6 border-t border-gray-200">
                    ...
                    <button type="submit"
                        class="px-6 py-3 bg-gradient-to-r from-yellow-500 to-yellow-600 text-white rounded-lg hover:from-yellow-600 hover:to-yellow-700 transition-all duration-200 shadow-lg hover:shadow-xl flex items-center">

...
<div class="container mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
        <div class="bg-gradient-to-r from-indigo-50 to-blue-50 px-8 py-6 border-b border-gray-200">
            ...
            <p class="text-sm text-gray-600 mt-1">Update informasi FAQ</p>
        </div>

        <form action="{{ route('admin.faqs.update', $faq->id) }}" method="POST" class="px-8 py-6 space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid md:grid-cols-2 gap-6">
                <div>
                    ...
                    >
                        ...
                        <option value="program" {{ old('category', $faq->category) == 'program' ? 'selected' : '' }}>Program</option>

...
<div class="container mx-auto max-w-4xl">
    ...
    <div class="bg-white rounded-xl shadow-lg p-8">
        <form action="{{ route('admin.program-news.store') }}" method="POST" x-data="{ features: ['', ''], loading: false }" @submit="loading = true">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="card_type" value="{{ old('card_type') }}" required placeholder="Contoh: Belajar Mandiri"
                ...
                <div>
                    ...
                    <input type="text" name="sold_count" value="{{ old('sold_count') }}" placeholder="Contoh: 450 terjual"
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                </div>
                ...
                <div>
                    ...
                    <select name="level" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 @error('level') border-red-500 @enderror">
                        ...
                        <option value="profesi" {{ old('level') == 'profesi' ? 'selected' : '' }}>Profesi</option>

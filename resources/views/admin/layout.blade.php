...
<head>
  ...
  <nav class="p-6 space-y-2 pt-2">
      ...
      <a href="{{ route('admin.formulir.index') }}" class="sidebar-item flex items-center p-3 rounded-lg text-white/90 hover:bg-white/10 hover:text-white">
        <div class="w-8 h-8 bg-white/10 rounded flex items-center justify-center mr-3">
          <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
          </svg>
        ...
        <div>
          <div class="font-medium text-sm">Formulir</div>
          <div class="text-[10px] text-white/60">Pendaftaran</div>
        </div>
      </a>
